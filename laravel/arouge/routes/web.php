...
Route::post('/store/list', 'App\Http\Controllers\StoreController@list')->name('store_list');
Route::get('/store/input', 'App\Http\Controllers\StoreController@input')->name('store_input');
Route::get('/store/input/{id}', 'App\Http\Controllers\StoreController@input')->name('store_input');
Route::get('/store/confirm', 'App\Http\Controllers\StoreController@confirm')->name('store_confirm');
Route::post('/store/confirm', 'App\Http\Controllers\StoreController@confirm')->name('store_confirm');
Route::get('/store/regist', 'App\Http\Controllers\StoreController@regist')->name('store_regist');
Route::post('/store/regist', 'App\Http\Controllers\StoreController@regist')->name('store_regist');
...
Route::post('/store_geleerich/list', 'App\Http\Controllers\StoreGeleerichController@list')->name('store_geleerich_list');
...
Route::post('/store_geleerich/confirm', 'App\Http\Controllers\StoreGeleerichController@confirm')->name('store_geleerich_confirm');
Route::get('/store_geleerich/regist', 'App\Http\Controllers\StoreGeleerichController@regist')->name('store_geleerich_regist');
Route::post('/store_geleerich/regist', 'App\Http\Controllers\StoreGeleerichController@regist')->name('store_geleerich_regist');
...
Route::post('/form/list', 'App\Http\Controllers\FormController@list')->name('form_list');
...
Route::post('/form/search', 'App\Http\Controllers\FormController@search')->name('form_search');
...
Route::get('/sample/input/{id}', 'App\Http\Controllers\SampleController@input')->name('sample_input');
